...
def process_image_with_model(image_path, weights_path, model_type, output_suffix):
    ...
    try:
        ...
        output_dir = "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/model_comparison_outputs"
...
def main():
    ...
    # Eingabebild
    image_path = "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/image/new_21_png_jpg.rf.d0c9323560db430e693b33b36cb84c3b.jpg"
    ...
    models = [
        {
            ...
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/weights/maskdino_r50_50ep_300q_hid1024_3sd1_instance_maskenhanced_mask46.1ap_box51.5ap.pth",
            "type": "pretrained",
            "suffix": "pretrained_coco"
        },
        {
            "name": "Fine-tuned Iter 500",
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_0000499.pth",
            "type": "finetuned",
            "suffix": "finetuned_iter500"
        },
        {
            "name": "Fine-tuned Iter 1000", 
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_0000999.pth",
            "type": "finetuned",
            "suffix": "finetuned_iter1000"
        },
        {
            "name": "Fine-tuned Iter 1500",
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_0001499.pth",
            "type": "finetuned",
            "suffix": "finetuned_iter1500"
        },
        {
            "name": "Fine-tuned Iter 2000",
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_0001999.pth",
            "type": "finetuned",
            "suffix": "finetuned_iter2000"
        },
        {
            "name": "Fine-tuned Iter 2500",
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_0002499.pth",
            "type": "finetuned",
            "suffix": "finetuned_iter2500"
        },
        {
            "name": "Fine-tuned Final",
            "weights": "/Users/nicklehmacher/Alles/MasterArbeit/MaskDINO/output/car_parts_finetune/model_final.pth",
            "type": "finetuned",
