...
from myThesis.linear_probing.linear_probing_extraction import extract_decoder_features_with_labels
...
def main(
    ...
    """
    Hauptfunktion für Linear Probing Feature-Extraktion auf dem Decoder.
    ...
    print(f"🚀 Starte Decoder Linear Probing Extraktion für {len(image_list)} Bilder…")
    
    success_count = 0
    for image_path, image_id, grau_mask, orange_mask, blau_mask in image_list:
        print(f"\n📷 Verarbeite: {image_id}")
        
        success = extract_decoder_features_with_labels(
            model=model_nn,
    ...
    print(f"\n✅ Decoder Linear Probing abgeschlossen: {success_count}/{len(image_list)} erfolgreich")
...
if __name__ == "__main__":
    ...
    main(
        ...
        output_dir="/Users/nicklehmacher/Alles/MasterArbeit/myThesis/output/linear_probing/decoder",
        model="butterfly",
    )
